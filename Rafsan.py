...
try:
    os.system('clear')
    xnx = requests.get('https://github.com/Rafsan-402/Trick/blob/main/Trick.txt').text
...
def menu():
  ...
  try:
    httpCaht = requests.get('https://github.com/Rafsan-402/Trick/blob/main/Trick.txt').text    
    if id in httpCaht:
