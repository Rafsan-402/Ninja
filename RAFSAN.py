...
try:
	prox= requests.get('https://raw.githubusercontent.com/Rafsan-402/Trick/main/Trick.txt').text
...
try:
    os.system('clear')
    xnx = requests.get('https://raw.githubusercontent.com/Rafsan-402/Trick/main/Trick.txt').text
...
def menu():
  ...
  try:
    httpCaht = requests.get('https://raw.githubusercontent.com/Rafsan-402/Trick/main/Trick.txt').text    
    if id in httpCaht:
